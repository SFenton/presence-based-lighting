...
class TestManualDisableStatesEmpty:
    ...
    @pytest.mark.asyncio
    async def test_empty_list_means_no_states_disable_automation(
    ...
    @pytest.mark.asyncio
    async def test_empty_list_allows_presence_to_turn_on_after_manual_off(
        self, mock_hass, mock_config_entry
    ):
...
class TestManualDisableStatesOff:
    ...
    @pytest.mark.asyncio
    async def test_manual_off_disables_when_off_in_list(
        self, mock_hass, mock_config_entry
    ):
    ...
    @pytest.mark.asyncio
    async def test_manual_on_re_enables_when_off_in_list(
        self, mock_hass, mock_config_entry
    ):
    ...
    @pytest.mark.asyncio
    async def test_presence_blocked_after_manual_off(
        self, mock_hass, mock_config_entry
    ):
...
class TestManualDisableStatesOn:
    ...
    @pytest.mark.asyncio
    async def test_manual_on_disables_when_on_in_list(
        self, mock_hass, mock_config_entry
    ):
    ...
    @pytest.mark.asyncio
    async def test_manual_off_re_enables_when_on_in_list(
        self, mock_hass, mock_config_entry
    ):
    ...
    @pytest.mark.asyncio
    async def test_presence_cleared_blocked_after_manual_on(
        self, mock_hass, mock_config_entry
    ):
        ...
        turn_off_calls = [
            c for c in mock_hass.services.calls if c["service"] == "turn_off"
        ]
...
class TestManualDisableStatesCustomStates:
    ...
    @pytest.mark.asyncio
    async def test_custom_state_disables_when_in_list(
        self, mock_hass, mock_config_entry
    ):
    ...
    @pytest.mark.asyncio
    async def test_custom_state_not_in_list_re_enables(
        self, mock_hass, mock_config_entry
    ):
...
class TestManualDisableStatesServiceCalls:
    ...
    @pytest.mark.asyncio
    async def test_service_call_turn_off_disables_when_off_in_list(
        self, mock_hass, mock_config_entry
    ):
    ...
    @pytest.mark.asyncio
    async def test_service_call_turn_on_re_enables_when_off_in_list(
        self, mock_hass, mock_config_entry
    ):
...
class TestManualDisableStatesInteractionWithOtherSettings:
    ...
    @pytest.mark.asyncio
    async def test_disable_on_external_false_ignores_manual_disable_states(
        self, mock_hass, mock_config_entry
    ):
    ...
    @pytest.mark.asyncio
    async def test_missing_manual_disable_states_uses_legacy_behavior(
        self, mock_hass, mock_config_entry
    ):
        ...
        if (
            CONF_MANUAL_DISABLE_STATES
            in mock_config_entry.data[CONF_CONTROLLED_ENTITIES][0]
        ):
            del mock_config_entry.data[CONF_CONTROLLED_ENTITIES][0][
                CONF_MANUAL_DISABLE_STATES
            ]
...
class TestManualDisableStatesMultipleEntities:
    ...
    @pytest.mark.asyncio
    async def test_different_entities_have_different_disable_states(
        self, mock_hass, mock_config_entry
    ):
